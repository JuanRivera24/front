...
Debe conectarse correctamente con la API de Java (`ap_i_tm`)
para funcionar en modo de desarrollo.

2️⃣ INSTALACIÓN Y EJECUCIÓN  
----------------------------
git clone https://github.com/JuanRivera24/front.git  
cd front  
npm install  
npm run dev  
...
**FRONT** es la interfaz visual de Kingdom Barber, dirigida tanto a
...
👉 https://ap-i-tm.onrender.com/citas-activas  
